...
import pinetree.lifenavi.view.TextStyleSurfaceView;

public class TextureStyleActvitity extends Activity {
    private TextStyleSurfaceView mGLSurfaceView;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //初始化GLSurfaceView
        mGLSurfaceView = new TextStyleSurfaceView(this);
