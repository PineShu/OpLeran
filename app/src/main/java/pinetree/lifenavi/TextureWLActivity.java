...
import pinetree.lifenavi.view.TectureRectSurfaceView;

public class TextureWLActivity extends Activity {
    private TectureRectSurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //切换到主界面
        setContentView(R.layout.main_rectrs);

        //初始化GLSurfaceView
        mGLSurfaceView = new TectureRectSurfaceView(this);
