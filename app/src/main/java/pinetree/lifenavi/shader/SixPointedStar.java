...
import pinetree.lifenavi.utils.MatrixState;
import pinetree.lifenavi.utils.ShaderUtil;
import pinetree.lifenavi.view.MSurfaceView;

import static pinetree.lifenavi.utils.ShaderUtil.createProgram;

/**
 * Created by shisk on 2019/3/19.
 */
...
public class SixPointedStar
{
    ...
    public SixPointedStar(MSurfaceView mv, float r, float R, float z)
    {
    ...
    //初始化着色器的initShader方法
    public void initShader(MSurfaceView mv)
    {
        //加载顶点着色器的脚本内容
