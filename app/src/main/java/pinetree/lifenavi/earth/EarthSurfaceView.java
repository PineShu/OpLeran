...
import pinetree.lifenavi.view.BaseGLSurfaceView;

public class EarthSurfaceView extends BaseGLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                MatrixHelper.setLightLocation(sunx, 5, sunz);
                ...
                MatrixHelper.setLookAt(0,0, cy, cz, 0, 0, 0, 0, upy, upz);
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //地球自转
        MatrixHelper.roate(eAngle, 0, 1, 0);
        //绘制地球
        earth.drawSelf(textureIdEarth, textureIdEarthNight);
        //推坐标系到月球位置
        MatrixHelper.translate(2f, 0, 0);
        //月球自转
        MatrixHelper.roate(eAngle, 0, 1, 0);
        //绘制月球
        ...
        MatrixHelper.pushMatrix();
        //星空天球旋转
        MatrixHelper.roate(cAngle, 0, 1, 0);
        //绘制小尺寸星星的天球
        cSmall.draw();
        //绘制大尺寸星星的天球
        cBig.draw();
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
       ...
       float ratio = (float) width / height;
        //调用此方法计算产生透视投影矩阵
        MatrixHelper.setFrust(0,-ratio, ratio, -1, 1, 4f, 100);
        //调用此方法产生摄像机9参数位置矩阵
        MatrixHelper.setLookAt(0,0, 0, 7.2f, 0f, 0f, 0f, 0f, 1.0f, 0.0f);
        //打开背面剪裁
        ...
        //设置太阳灯光的初始位置
        MatrixHelper.setLightLocation(100, 5, 0);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //创建小星星天球对象
        cSmall = new Celestial(1, 1000 );
        //创建大星星天球对象
        cBig = new Celestial(2,  500);

        //创建地球对象
        earth = new Earth( 2.0f);
        //创建月球对象
        moon = new Moon( 1.0f);
